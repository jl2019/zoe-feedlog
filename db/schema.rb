...
ActiveRecord::Schema.define(version: 2019_05_14_151214) do
  ...
  create_table "feedables", force: :cascade do |t|
    t.bigint "pet_id"
    t.bigint "user_id"
    t.index ["pet_id"], name: "index_feedables_on_pet_id"
    t.index ["user_id"], name: "index_feedables_on_user_id"
  end
  ...
  add_foreign_key "feedables", "pets"
  add_foreign_key "feedables", "users"
